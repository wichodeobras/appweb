...
function DisVigaORRFlex() {
    ...
    const handleShowProperties = () => {
        ...
        if (profile) {
            setProfileProps({
                ...
                rx: profile.rx,
                ry: profile.ry,
                b_t: profile.pandeo_b_t,
                h_t: profile.pandeo_h_t,
                d: profile.d,
                h: profile.h,
                bf: profile.bf,
                tf: profile.tf,
    ...
    // ========= CLASIFICACIONES =========
    useEffect(() => {
        if (E && Fy && profileProps.b_t && profileProps.h_t) {
            setClasificacionPatin(
                ClasificacionPatin(
                    Number(profileProps.b_t),
                    Number(E),
                    Number(Fy)
                )
            );
    ...
    }, [E, Fy, profileProps.b_t, profileProps.h_t]);

    const ClasificacionPatin = (b_t, E, Fy) => {
        const lambda = b_t;
        const lambdap = 1.12 * Math.sqrt(E / Fy);
        const lambdar = 1.40 * Math.sqrt(E / Fy);
    ...
    const ClasificacionAlma = (h_t, E, Fy) => {
        const lambda = h_t;
        const lambdap = 2.42 * Math.sqrt(E / Fy);
    ...
    return (
        <div style={styles.page}>
            <header>
                <h1>DISEÑO POR FLEXIÓN VIGA ORR</h1>
            ...
            <section style={styles.container}>
                ...
                <div style={styles.divv}>
                    ...
                    <div style={styles.label}>
                        <label style={styles.tit1}>b/t</label>
                        <input type="number" name="b2tf" style={styles.input} value={profileProps.b_t || ""} readOnly />
                    </div>

                    <div style={styles.label}>
                        <label style={styles.tit1}>h/t</label>
                        <input type="number" name="htw" style={styles.input} value={profileProps.h_t || ""} readOnly />
                    </div>
                </div>
